...
export const metadata: Metadata = {
  ...
  description: "A website that exists solely as the base of a tutorial of sorts, for now.", // Description of the application for SEO.
};
    ...
    <html lang="en">
      ...
      <body className={inter.className}>
        ...
        <ToastProvider>
          ...
          <Toast /> {/* Render the Toast component to display notifications at the top level. */}
          {children}
